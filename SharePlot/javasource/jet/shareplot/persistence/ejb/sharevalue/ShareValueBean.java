...
public class ShareValueBean implements EntityBean {
    ...
    public java.lang.Object ejbCreate( Long idShareValue, Long isShare, java.math.BigDecimal value, java.util.Date valueDate) throws CreateException {
        this.idShareValue = idShareValue;
        this.isShare = isShare;
        this.value = value;
        if (valueDate == null) {
     ...
     */
    @SuppressWarnings({"hiding"})
    public void ejbPostCreate( Long idShareValue, Long isShare, java.math.BigDecimal value, java.util.Date valueDate) throws CreateException {
     ...
     */
    @SuppressWarnings({"hiding"})
    public void update( Long isShare, java.math.BigDecimal value, java.util.Date valueDate) throws EJBException {
