...
public final class ShareQuantityBean implements EntityBean {
    ...
    @Nullable
    public java.lang.Object ejbCreate(final Long idShareQuantity, final java.math.BigDecimal changeFee, final java.math.BigDecimal changeQuantity, final String changeType, final java.math.BigDecimal changeValue, final String description, final Long idShare, final java.util.Date valueDate) throws CreateException {
        this.idShareQuantity = idShareQuantity;
        this.changeFee = changeFee;
        this.changeQuantity = changeQuantity;
        this.changeType = changeType;
     ...
     */
    @SuppressWarnings("hiding")
    public void ejbPostCreate(final Long idShareQuantity, final java.math.BigDecimal changeFee, final java.math.BigDecimal changeQuantity, final String changeType, final java.math.BigDecimal changeValue, final String description, final Long idShare, final java.util.Date valueDate) throws CreateException {
     ...
     */
    @SuppressWarnings("hiding")
    public void update(final java.math.BigDecimal changeFee, final java.math.BigDecimal changeQuantity, final String changeType, final java.math.BigDecimal changeValue, final String description, final Long idShare, final java.util.Date valueDate) throws EJBException {
