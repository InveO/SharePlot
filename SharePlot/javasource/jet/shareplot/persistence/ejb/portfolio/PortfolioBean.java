...
public final class PortfolioBean implements EntityBean {
     ...
     * @throws EJBException Thrown by the method to indicate a failure caused by a system-level error.
     */
    public @Nullable String getIsFake() throws EJBException {
        return this.isFake;
     ...
     * @throws EJBException Thrown by the method to indicate a failure caused by a system-level error.
     */
    public void setIsFake(final @Nullable String isFake) throws EJBException {
        this.isFake = isFake;
    }
    ...
    public java.lang.@Nullable Object ejbCreate(final Long idPortfolio, final String isFake, final String name) throws CreateException {
        this.idPortfolio = idPortfolio;
        this.isFake = isFake;
        this.name = name;
        return null;
