...
public class PortfolioBean implements EntityBean {
    ...
    public java.lang.Object ejbCreate( Long idPortfolio, String name, String isFake) throws CreateException {
        this.idPortfolio = idPortfolio;
        this.name = name;
        this.isFake = isFake;
        return null;
     ...
     */
    @SuppressWarnings({"hiding"})
    public void ejbPostCreate( Long idPortfolio, String name, String isFake) throws CreateException {
     ...
     */
    @SuppressWarnings({"hiding"})
    public void update( String name, String isFake) throws EJBException {
