 ...
 */
public final class ShareQuantity_FindAll0 implements FinderMethod<ShareQuantityImut> {
    ...
    public @NonNull List<@NonNull ShareQuantityImut> callImutFinder() throws JETException, FinderObjectNotFoundException {
        ...
        try {
            ...
            final Collection<@NonNull ShareQuantityRemote> list = home.findAll();
