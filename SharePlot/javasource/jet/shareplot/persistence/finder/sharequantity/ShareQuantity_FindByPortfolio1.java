 ...
 */
public final class ShareQuantity_FindByPortfolio1 implements FinderMethod<ShareQuantityImut> {
    ...
    public @NonNull ModelArray callFinder() throws JETException, FinderObjectNotFoundException {
        ...
        try {
            ...
            list = sharequantity.findByPortfolio(this.idPortfolio);
    ...
    public @NonNull List<@NonNull ShareQuantityImut> callImutFinder() throws JETException, FinderObjectNotFoundException {
        ...
        try {
            ...
            final Collection<@NonNull ShareQuantityRemote> list = home.findByPortfolio(this.idPortfolio);
