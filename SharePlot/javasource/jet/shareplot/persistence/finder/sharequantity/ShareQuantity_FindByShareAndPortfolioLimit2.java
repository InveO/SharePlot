...
/**
 * Class for the findByShareAndPortfolioLimit FinderMethod object for the ShareQuantity component.
 *
 * SQL Query : where idPortfolio = ? and idShare = ? order by valueDate desc limit 1
 *
 * Generated by JetTools, do not edit this file directly.
 */
public final class ShareQuantity_FindByShareAndPortfolioLimit2 implements FinderMethod<ShareQuantityImut> {
    ...
    public @NonNull ModelArray callFinder() throws JETException, FinderObjectNotFoundException {
        ...
        try {
            ...
            list = sharequantity.findByShareAndPortfolioLimit(this.idPortfolio, this.idShare);
    ...
    public @NonNull List<@NonNull ShareQuantityImut> callImutFinder() throws JETException, FinderObjectNotFoundException {
        ...
        try {
            ...
            final Collection<@NonNull ShareQuantityRemote> list = home.findByShareAndPortfolioLimit(this.idPortfolio, this.idShare);
