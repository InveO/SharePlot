 ...
 */
public final class ShareQuantity_FindByShareAndPortfolioLimit2 implements FinderMethod {
    ...
    public @NonNull ModelArray callFinder() throws JETException, FinderObjectNotFoundException {
        ...
        try {
            ...
            list = (List<ShareQuantityRemote>) sharequantity.findByShareAndPortfolioLimit(this.idPortfolio, this.idShare);
