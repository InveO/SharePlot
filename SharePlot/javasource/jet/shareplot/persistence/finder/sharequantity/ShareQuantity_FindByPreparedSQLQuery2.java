 ...
 */
public final class ShareQuantity_FindByPreparedSQLQuery2 implements FinderMethod<ShareQuantityImut> {
    ...
    public @NonNull ModelArray callFinder() throws JETException, FinderObjectNotFoundException {
        ...
        try {
            ...
            list = sharequantity.findByPreparedSQLQuery(this.sqlWhereClause, this.sqlArguments);
    ...
    public @NonNull List<@NonNull ShareQuantityImut> callImutFinder() throws JETException, FinderObjectNotFoundException {
        ...
        try {
            ...
            final Collection<@NonNull ShareQuantityRemote> list = home.findByPreparedSQLQuery(this.sqlWhereClause, this.sqlArguments);
