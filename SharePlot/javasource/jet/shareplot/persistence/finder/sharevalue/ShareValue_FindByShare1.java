 ...
 */
public final class ShareValue_FindByShare1 implements FinderMethod<ShareValueImut> {
    ...
    public @NonNull ModelArray callFinder() throws JETException, FinderObjectNotFoundException {
        ...
        try {
            ...
            list = sharevalue.findByShare(this.idShare);
    ...
    public @NonNull List<@NonNull ShareValueImut> callImutFinder() throws JETException, FinderObjectNotFoundException {
        ...
        try {
            ...
            final Collection<@NonNull ShareValueRemote> list = home.findByShare(this.idShare);
