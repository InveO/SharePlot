 ...
 */
public final class ShareValue_FindByPreparedSQLQuery2 implements FinderMethod<ShareValueImut> {
    ...
    public @NonNull ModelArray callFinder() throws JETException, FinderObjectNotFoundException {
        ...
        try {
            ...
            list = sharevalue.findByPreparedSQLQuery(this.sqlWhereClause, this.sqlArguments);
    ...
    public @NonNull List<@NonNull ShareValueImut> callImutFinder() throws JETException, FinderObjectNotFoundException {
        ...
        try {
            ...
            final Collection<@NonNull ShareValueRemote> list = home.findByPreparedSQLQuery(this.sqlWhereClause, this.sqlArguments);
