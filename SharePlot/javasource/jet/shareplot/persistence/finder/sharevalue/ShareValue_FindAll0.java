 ...
 */
public final class ShareValue_FindAll0 implements FinderMethod<ShareValueImut> {
    ...
    public @NonNull List<@NonNull ShareValueImut> callImutFinder() throws JETException, FinderObjectNotFoundException {
        ...
        try {
            ...
            final Collection<@NonNull ShareValueRemote> list = home.findAll();
