 ...
 */
public final class Portfolio_FindByPreparedSQLQuery2 implements FinderMethod<PortfolioImut> {
    ...
    public @NonNull ModelArray callFinder() throws JETException, FinderObjectNotFoundException {
        ...
        try {
            ...
            list = portfolio.findByPreparedSQLQuery(this.sqlWhereClause, this.sqlArguments);
    ...
    public @NonNull List<@NonNull PortfolioImut> callImutFinder() throws JETException, FinderObjectNotFoundException {
        ...
        try {
            ...
            final Collection<@NonNull PortfolioRemote> list = home.findByPreparedSQLQuery(this.sqlWhereClause, this.sqlArguments);
