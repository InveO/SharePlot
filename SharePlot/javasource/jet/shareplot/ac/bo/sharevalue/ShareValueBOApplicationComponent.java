...
public class ShareValueBOApplicationComponent extends AbstractShareValueBOApplicationComponent {
     ...
     */
    private final static String NAME = "ShareValueBOApplicationComponent";
    /**
     * <code>SESSION_KEY</code> session key
     */
    private final static Object SESSION_KEY = new SerializableKey(ShareValueBOApplicationComponent.class, "SESSION_KEY");
