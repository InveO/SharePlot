 ...
 */
abstract class AbstractShareApplicationComponent extends SimpleApplicationComponent {
    ...
    protected List<Share> getShares(final FinderMethod finder) {
        ...
        final AbstractShareApplicationComponent shareAC = this;
        ...
        try {
            ...
            logp(JETLevel.SEVERE, "AbstractShareApplicationComponent", "getShares", e.getMessage(), e);
