...
public class PortfolioBOApplicationComponent extends AbstractPortfolioBOApplicationComponent {
     ...
     */
    private final static String NAME = "PortfolioBOApplicationComponent";
    /**
     * <code>SESSION_KEY</code> session key
     */
    private final static Object SESSION_KEY = new SerializableKey(PortfolioBOApplicationComponent.class, "SESSION_KEY");
