 ...
 */
abstract class AbstractPortfolioApplicationComponent extends SimpleApplicationComponent {
    ...
    protected List<Portfolio> getPortfolios(final FinderMethod finder) {
        ...
        final AbstractPortfolioApplicationComponent portfolioAC = this;
        ...
        try {
            ...
            logp(JETLevel.SEVERE, "AbstractPortfolioApplicationComponent", "getPortfolios", e.getMessage(), e);
