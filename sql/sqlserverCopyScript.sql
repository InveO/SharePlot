...
INSERT INTO [ShareQuantity] (
 [idShareQuantity] , [changeFee] , [changeQuantity] , [changeType] , [changeValue] , [description] , [idPortfolio] , [idShare] , [valueDate] )
SELECT
 [idShareQuantity] , [changeFee] , [changeQuantity] , [changeType] , [changeValue] , [description] , [idPortfolio] , [idShare] , [valueDate] FROM BSJA_03..[ShareQuantity]
