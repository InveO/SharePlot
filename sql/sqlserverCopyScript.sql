...
INSERT INTO [Share] (
 [idShare] , [codeISIN] , [codeYahoo] , [description] , [name] )
SELECT
 [idShare] , [codeISIN] , [codeYahoo] , [description] , [name] FROM BSJA_03..[Share]
...
INSERT INTO [ShareQuantity] (
 [idShareQuantity] , [changeFee] , [changeQuantity] , [changeType] , [changeValue] , [description] , [idPortfolio] , [idShare] , [totalQuantity] , [valueDate] )
SELECT
 [idShareQuantity] , [changeFee] , [changeQuantity] , [changeType] , [changeValue] , [description] , [idPortfolio] , [idShare] , [totalQuantity] , [valueDate] FROM BSJA_03..[ShareQuantity]
