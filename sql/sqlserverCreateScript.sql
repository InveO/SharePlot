...
ALTER TABLE [dbo].[ShareQuantity]  WITH CHECK ADD  CONSTRAINT [fk_ShareQuantity_Portfolio] FOREIGN KEY([idPortfolio] )
REFERENCES [dbo].[Portfolio] ([idPortfolio])
GO
ALTER TABLE [dbo].[ShareQuantity] CHECK CONSTRAINT [fk_ShareQuantity_Portfolio]
GO
...
ALTER TABLE [dbo].[ShareValue]  WITH CHECK ADD  CONSTRAINT [fk_ShareValue_Share] FOREIGN KEY([idShare] )
REFERENCES [dbo].[Share] ([idShare])
GO
